...
app.post('/server/addnews', function(req, res) {
    var json = req.body;
    var sql = "INSERT INTO news SET  newstitle='" + json.newstitle + "', newsimg='" + json.newsimg + "',newscontent='" + json.newscontent + "',addtime='" + json.addtime + "',lanmu='" + json.lanmu + "'";
...
app.post('/server/renew', function(req, res) {
    var json = req.body;
    var sql = "update news set newstitle='" + json.newstitle + "', newsimg='" + json.newsimg + "',newscontent='" + json.newscontent + "',addtime='" + json.addtime + "',lanmu='" + json.lanmu + "' where newsid='" + json.newsid + "'";
    connection.query(sql, function(error, results) {
        if (error) {
            console.log("插入记录出错: " + error.message);
            return;
